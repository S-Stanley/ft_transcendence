...
const Pong = (props: {my_id: number, opp_id: number, nickname: string}) => {

    console.log(props.my_id, props.opp_id, props.nickname);
    ...
    socket.on(user.id_42.toString(), (data: { position: number, }) => {
        tmp = data.position;
    });
